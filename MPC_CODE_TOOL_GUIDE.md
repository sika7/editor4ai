---
title: 'Editor4AI のツールガイド'
author: 'sika7'
tags: ['Editor4AI', 'ツールガイド']
date: 2025-05-30
audience: ['AIエージェント']
---

# Editor4AI AIツール使用ガイド

このガイドはAIエージェントがEditor4AIツールを効果的に使用するためのベストプラクティスとよくある問題の解決方法をまとめています。
...
- 設定ファイル（`~/.config/editor4ai/config.yaml`）で除外されたファイルは操作不可
...
このガイドに従うことで、Editor4AIツールを安全かつ効率的に使用できます。特に行番号の管理と複数行操作のまとめ実行を意識することで、エラーを防ぎスムーズな開発が可能になります。
